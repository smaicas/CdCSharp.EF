...
{
    private readonly MultiTenantDbContextTests_MultiTenantDbContext _context;
    ...
    public MultiTenantDbContextTests()
    {
        ...
        DbContextOptions<MultiTenantDbContextTests_MultiTenantDbContext> options = new DbContextOptionsBuilder<MultiTenantDbContextTests_MultiTenantDbContext>()
            .UseInMemoryDatabase(databaseName: Guid.NewGuid().ToString())
            .Options;

        // Pasar features y procesadores (vacíos por defecto)
        _context = new MultiTenantDbContextTests_MultiTenantDbContext(options, _serviceProvider);
    }
    ...
    public async Task SaveChangesAsync_WhenAddingTenantEntity_SetsTenantId()
    {
        ...
        MultiTenantDbContextTests_TenantEntity product = new() { Name = "Test Product", Price = 100 };
    ...
    public async Task Query_WithTenantFilter_FiltersCorrectly()
    {
        ...
        MultiTenantDbContextTests_TenantEntity product1 = new() { Name = "Product 1", Price = 100, TenantId = tenant1 };
        MultiTenantDbContextTests_TenantEntity product2 = new() { Name = "Product 2", Price = 200, TenantId = tenant2 };
        MultiTenantDbContextTests_TenantEntity product3 = new() { Name = "Product 3", Price = 300, TenantId = tenant1 };
        ...
        // Act
        List<MultiTenantDbContextTests_TenantEntity> products = await _context.Products.ToListAsync();
    ...
    internal class MultiTenantDbContextTests_MultiTenantDbContext : MultiTenantDbContext
    {
        public MultiTenantDbContextTests_MultiTenantDbContext(DbContextOptions<MultiTenantDbContextTests_MultiTenantDbContext> options,
            IServiceProvider serviceProvider)
            : base(options, serviceProvider)
        {
        }

        public DbSet<MultiTenantDbContextTests_TenantEntity> Products { get; set; } = null!;
    }

    internal class MultiTenantDbContextTests_TenantEntity : ITenantEntity
    {
