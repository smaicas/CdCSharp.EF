...
public class ProductsController : ControllerBase
{
    ...
    public ProductsController(IntegrationTestDbContext context) => _context = context;
    ...
    {
        TestProduct? product = await _context.Products.FindAsync(id);
        if (product == null)
            return NotFound();
...
public class OrdersController : ControllerBase
{
    ...
    public OrdersController(IntegrationTestDbContext context) => _context = context;

    [HttpGet]
    public async Task<IActionResult> GetOrders()
    {
        List<TestOrder> orders = await _context.Orders
            .Include(o => o.Items)
    ...
    {
        TestOrder? order = await _context.Orders
            .Include(o => o.Items)
            .ThenInclude(i => i.Product)
    ...
    public async Task<IActionResult> CreateOrder([FromBody] CreateOrderRequest request)
    {
        ...
        {
            TestProduct? product = await _context.Products.FindAsync(itemRequest.ProductId);
            if (product == null)
                return BadRequest($"Product with ID {itemRequest.ProductId} not found");

            TestOrderItem orderItem = new()
            {
